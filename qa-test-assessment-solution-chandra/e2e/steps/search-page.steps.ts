...
import { characterResults } from "../pages/characterResults.po";
import { planetResults } from "../pages/planetResults.po";
...
let characterResultsPo = new characterResults();
let planetResultsPo = new planetResults();
